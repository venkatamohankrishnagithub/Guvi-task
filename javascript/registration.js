function validate_Firstname(str){
    if(str.length<3){
...
function validate_Lastname(str){
    if(str.length<3){
        document.getElementById("err-name").innerText="name must have 3 or more characters";
		return false;
    }
...
function validate_fields(){
    ...
    let res3=validate_Firstname(document.getElementById("name").value);
	let res5=validate_Lastname(document.getElementById("name").value);
